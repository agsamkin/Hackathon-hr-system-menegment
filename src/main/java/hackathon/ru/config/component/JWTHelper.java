...
public class JWTHelper {
    ...
    public JWTHelper(@Value("${jwt.issuer:task_manager}") final String issuer,
                     @Value("${jwt.expiration-sec:86400}") final Long expirationSec, //  24 часа
                     @Value("${jwt.clock-skew-sec:300}") final Long clockSkewSec, //  5 минут
                     @Value("${jwt.secret:my_strong_secret}") final String secret) {
